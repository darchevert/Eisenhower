...
export function Q4Widget({ tasks }: Props) {
  ...
  return (
    ...
    >
      <FlexWidget style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 6 }}>
        <FlexWidget
          style={{ width: 8, height: 8, borderRadius: 4, backgroundColor: SLATE, marginRight: 6 }}
        />
        <FlexWidget style={{ flex: 1 }}>
          <TextWidget
            text="Eliminate"
            style={{ fontSize: 13, color: SLATE, fontWeight: 'bold' }}
            maxLines={1}
          />
        </FlexWidget>
      </FlexWidget>
